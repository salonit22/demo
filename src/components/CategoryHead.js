...
const CategoryHead = ({ data, show, passIndex }) => {
    ...
    const itemcard = data?.card?.card?.itemCards

    const handelClick = () => {
        passIndex()
    }
    return (
        <div className="align-middle my-4 font-bold text-lg bg-gray-100 w-6/12 m-auto p-3 rounded-lg shadow-md cursor-pointer" onClick={handelClick}>
